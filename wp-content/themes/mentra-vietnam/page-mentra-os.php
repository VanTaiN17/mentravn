...
$overview = [
    ...
    ['04', 'Làm thế nào để bắt đầu dùng MentraOS?', 'Nếu bạn đang dùng kính được hỗ trợ, có thể MentraOS đã có sẵn. Khi ứng dụng mặc định hiển thị "Powered by Mentra", MentraOS đang chạy bên trong. Nếu chưa, hãy kiểm tra tương thích, tải ứng dụng Mentra và kết nối kính để bắt đầu.', ['Tải ứng dụng Mentra', 'https://get.mentraglass.com']],
